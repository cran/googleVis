...
###################################################
### code chunk number 2: googleVis.Rnw:248-283 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 3: googleVis.Rnw:299-300 (eval = FALSE)
###################################################
## install.packages('googleVis') 


###################################################
### code chunk number 4: googleVis.Rnw:304-305
###################################################
library(googleVis)


###################################################
### code chunk number 5: googleVis.Rnw:307-308 (eval = FALSE)
###################################################
## library(googleVis)


###################################################
### code chunk number 6: googleVis.Rnw:310-311
###################################################
cat(googleVis:::gvisWelcomeMessage())


###################################################
### code chunk number 7: googleVis.Rnw:340-341 (eval = FALSE)
###################################################
## help('gvisMotionChart')


###################################################
### code chunk number 8: googleVis.Rnw:386-388
###################################################
data(Fruits)
Fruits
...
###################################################
### code chunk number 9: googleVis.Rnw:395-396
###################################################
 M <- gvisMotionChart(Fruits, idvar="Fruit", timevar="Year")


###################################################
### code chunk number 10: googleVis.Rnw:400-401 (eval = FALSE)
###################################################
##  str(M)


###################################################
### code chunk number 11: googleVis.Rnw:403-405
###################################################
...
###################################################
### code chunk number 12: googleVis.Rnw:410-412
###################################################
M$type
M$chartid
...
###################################################
### code chunk number 13: googleVis.Rnw:419-420
###################################################
print(M, tag='header')


###################################################
### code chunk number 14: googleVis.Rnw:435-436
###################################################
names(M$html$chart)


###################################################
### code chunk number 15: googleVis.Rnw:439-440
###################################################
print(M, tag='chart')  ## or cat(M$html$chart)


###################################################
### code chunk number 16: googleVis.Rnw:443-444 (eval = FALSE)
###################################################
## cat(M$html$chart['jsChart']) # or print(M, 'jsChart')


###################################################
### code chunk number 17: googleVis.Rnw:446-447
###################################################
cat(paste(substring( capture.output( cat(M$html$chart['jsChart']) ) , 0, 66), sep="\n", collapse="\n"))


###################################################
### code chunk number 18: googleVis.Rnw:452-453 (eval = FALSE)
###################################################
## print(M, tag='caption')


###################################################
### code chunk number 19: googleVis.Rnw:455-456
###################################################
cat(paste(substring( capture.output( cat(M$html$caption) ) , 0, 66), sep="\n", collapse="\n"))


###################################################
### code chunk number 20: googleVis.Rnw:459-460 (eval = FALSE)
###################################################
## print(M, tag='footer')


###################################################
### code chunk number 21: googleVis.Rnw:462-463
###################################################
cat(paste(substring( capture.output( cat(M$html$footer) ) , 0, 66), sep="\n", collapse="\n"))


###################################################
### code chunk number 22: googleVis.Rnw:470-471 (eval = FALSE)
###################################################
## plot(M)  # returns invisibly the file name


###################################################
### code chunk number 23: googleVis.Rnw:486-487 (eval = FALSE)
###################################################
## print(M, file="myGoogleVisChart.html")


###################################################
### code chunk number 24: googleVis.Rnw:516-517 (eval = FALSE)
###################################################
## plot.gvis("/Users/JoeBloggs/myGoogleVisChart.html")


###################################################
### code chunk number 25: googleVis.Rnw:573-582
###################################################
...
###################################################
### code chunk number 26: googleVis.Rnw:584-585 (eval = FALSE)
###################################################
## plot(GTM)


###################################################
### code chunk number 27: googleVis.Rnw:605-626 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 28: googleVis.Rnw:634-642 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 29: googleVis.Rnw:660-662 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 30: googleVis.Rnw:684-691
###################################################
...
###################################################
### code chunk number 31: googleVis.Rnw:693-694 (eval = FALSE)
###################################################
## plot(CR)


###################################################
### code chunk number 32: googleVis.Rnw:712-713 (eval = FALSE)
###################################################
## print(M, 'chart')  ## or cat(M$html$chart) 


###################################################
### code chunk number 33: googleVis.Rnw:716-717 (eval = FALSE)
###################################################
## print(M, 'chart', file='myfilename')


###################################################
### code chunk number 34: googleVis.Rnw:738-740 (eval = FALSE)
###################################################
## M <- gvisMotionChart(Fruits, "Fruit", "Year",
## 		     options=list(width=400, height=370))
...
###################################################
### code chunk number 35: googleVis.Rnw:743-744 (eval = FALSE)
###################################################
## print(M, 'chart')


###################################################
### code chunk number 36: googleVis.Rnw:781-783
###################################################
M <- gvisMotionChart(Fruits, "Fruit", "Year")
...
###################################################
### code chunk number 37: googleVis.Rnw:785-786 (eval = FALSE)
###################################################
## cat(G, file="myGadget.xml")


###################################################
### code chunk number 38: googleVis.Rnw:866-869 (eval = FALSE)
###################################################
## library(R.rsp) 
## browseRsp() 
...
###################################################
### code chunk number 39: googleVis.Rnw:873-874 (eval = FALSE)
###################################################
## file.path(system.file("rsp", package = "googleVis"), "index.rsp")


###################################################
### code chunk number 40: googleVis.Rnw:932-933 (eval = FALSE)
###################################################
## install.packages('brew')


###################################################
### code chunk number 41: googleVis.Rnw:967-968 (eval = FALSE)
###################################################
## system.file("brew", package = "googleVis")


###################################################
### code chunk number 42: googleVis.Rnw:992-1032 (eval = FALSE)
###################################################
## require(Rook)
## require(googleVis)
## s <- Rhttpd$new()
...
###################################################
### code chunk number 43: googleVis.Rnw:1051-1078 (eval = FALSE)
###################################################
## # server.R
## library(googleVis)
## 
...
###################################################
### code chunk number 44: googleVis.Rnw:1089-1091 (eval = FALSE)
###################################################
